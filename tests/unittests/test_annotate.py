...
from deduce.annotate import annotator
...
class TestAnnotateMethods(unittest.TestCase):
    def _test_annotator(
        ...
        document = docdeid.Document(text=text, tokenizers={"default": DeduceTokenizer()}, metadata=metadata or {})
    ...
    def test_annotate_initial_with_capital(self):
        ...
        annotator = annotator._get_name_pattern_annotators(lookup_sets=lookup_sets)["initial_with_capital"]

        metadata = {"patient": Person(first_names=["Jan"], surname="Jansen")}

        expected_annotations = {
            docdeid.Annotation(text="J. Jansen", start_char=62, end_char=71, tag="initiaal+naam"),
        }
    ...
    def test_annotate_interfix(self):
        ...
        annotator = annotator._get_name_pattern_annotators()["interfix_with_name"]

        metadata = {"patient": Person(first_names=["Jan"], surname="Jansen")}

        expected_annotations = {
            docdeid.Annotation(text="de Visser", start_char=191, end_char=200, tag="interfix+naam"),
        }
    ...
    def test_annotate_prefix(self):
        ...
        annotator = annotator._get_name_pattern_annotators()["prefix_with_name"]

        metadata = {"patient": Person(first_names=["Jan"], surname="Jansen")}

        expected_annotations = {
            docdeid.Annotation(text="patient J", start_char=54, end_char=63, tag="prefix+naam"),
        }
    ...
    def test_annotate_person_surname(self):
        ...
        annotator = annotator._get_name_pattern_annotators()["person_surname"]
    ...
    def test_annotate_initials(self):
        ...
        annotator = annotator._get_name_pattern_annotators()["person_initials"]

        metadata = {
            "patient": Person(first_names=["Peter", "Charles"], surname="de Jong", initials="C", given_name="Charlie")
        }

        expected_annotations = {
            docdeid.Annotation(text="C", start_char=29, end_char=30, tag="initialen_patient"),
    ...
    def test_annotate_initials_attached(self):
        ...
        annotator = annotator._get_name_pattern_annotators()["person_initial_from_name"]

        metadata = {
            "patient": Person(first_names=["Nicholas", "David"], surname="de Jong", initials="ND", given_name="Niek")
        }

        expected_annotations = {docdeid.Annotation(text="N", start_char=14, end_char=15, tag="initiaal_patient")}
    ...
    def test_annotate_address_no_number(self):
        ...
        annotator = annotator.get_doc_processors()["street_with_number"]

        expected_annotations = {docdeid.Annotation(text="Havikstraat", start_char=10, end_char=21, tag="locatie")}
    ...
    def test_annotate_address_with_number(self):
        ...
        expected_annotations = {docdeid.Annotation(text="Havikstraat 43", start_char=10, end_char=24, tag="locatie")}
    ...
    def test_preserve_institution_casing(self):
        ...
        annotator = annotator.get_doc_processors()["institution"]

        expected_annotations = {docdeid.Annotation(text="Altrecht", start_char=10, end_char=18, tag="instelling")}
    ...
    def test_skip_mg(self):
        ...
        annotator = annotator.get_doc_processors()["postal_code"]
    ...
    def test_annotate_postcode(self):
        ...
        expected_annotations = {docdeid.Annotation(text="3500LX", start_char=17, end_char=23, tag="locatie")}
    ...
    def test_keep_punctuation_after_date(self):
        ...
        annotator = annotator.get_doc_processors()["date_1"]

        expected_annotations = {docdeid.Annotation(text="26-10", start_char=18, end_char=23, tag="datum")}
    ...
    def test_two_dates_with_comma(self):
        ...
        annotator = annotator.get_doc_processors()["date_2"]

        expected_annotations = {
            docdeid.Annotation(text="24 april", start_char=0, end_char=8, tag="datum"),
            docdeid.Annotation(text="1 mei", start_char=10, end_char=15, tag="datum"),
        }
