...
class TestUtilityMethods(unittest.TestCase):
    ...
    def test_find_name_tags(self):
        annotated_text = "Dit is stukje tekst met daarin de naam <VOORNAAMPAT Jan> <ACHTERNAAMPAT Jansen>. De " \
        ...
        expected_tags = ["<VOORNAAMPAT Jan>", "<ACHTERNAAMPAT Jansen>", "<PREFIXNAAM patient J>",
                         "<ACHTERNAAMPAT Jansen>",
                         "<VOORNAAMONBEKEND Peter>", "<INTERFIXNAAM de Visser>"]
        self.assertEqual(expected_tags, found_tags)

    def test_get_annotations(self):
        text = "Dit is stukje tekst met daarin de naam <VOORNAAMPAT Jan> <ACHTERNAAMPAT Jansen>. De " \
                        "<PREFIXNAAM patient J>. <ACHTERNAAMPAT Jansen> (e: j.jnsen@email.com, t: 06-12345678) is 64 " \
                        "jaar oud en woonachtig in Utrecht. Hij werd op 10 oktober door arts <VOORNAAMONBEKEND " \
                        "Peter> <INTERFIXNAAM de Visser> ontslagen van de kliniek van het UMCU."
        tags = ["<VOORNAAMPAT Jan>", "<ACHTERNAAMPAT Jansen>", "<PREFIXNAAM patient J>", "<ACHTERNAAMPAT Jansen>",
                "<VOORNAAMONBEKEND Peter>", "<INTERFIXNAAM de Visser>"]
        expected_annotations = [Annotation(39, 42, "VOORNAAMPAT", "Jan"),
    ...
    def test_annotate_text(self):
        annotated_text = "Dit is stukje tekst met daarin de naam <PATIENT Jan Jansen>. De " \
        ...
        expected_annotations = [Annotation(39, 49, "PATIENT", "Jan Jansen"),
